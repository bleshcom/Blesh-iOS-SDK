...
#ifndef BLESHSDK_SWIFT_H
#define BLESHSDK_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="BleshSDK",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@property (nonatomic, weak) id <BleshSdkDelegate> _Nullable delegate;
...
SWIFT_CLASS("_TtC8BleshSDK23BleshSdkApplicationUser")
@interface BleshSdkApplicationUser : NSObject
- (nonnull instancetype)initWithUserId:(NSString * _Nullable)userId genderCode:(NSNumber * _Nullable)genderCode yearOfBirth:(NSNumber * _Nullable)yearOfBirth email:(NSString * _Nullable)email phoneNumber:(NSString * _Nullable)phoneNumber other:(NSDictionary<NSString *, NSString *> * _Nullable)other OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end

typedef SWIFT_ENUM(NSInteger, BleshSdkApplicationUserGender, open) {
  BleshSdkApplicationUserGenderFemale = 0,
  BleshSdkApplicationUserGenderMale = 1,
};
...
SWIFT_PROTOCOL("_TtP8BleshSDK16BleshSdkDelegate_")
@protocol BleshSdkDelegate
@optional
